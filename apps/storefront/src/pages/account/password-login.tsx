...
const PasswordLoginPage = () => {
  ...
  }, [isAuthenticated, navigate, router, countryCode, search.redirect])
      ...
      >
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#aaa" }}>
                  <EmailIcon />
                </span>
                <input
                  type="email"
            ...
            <div className="flex items-center justify-center gap-1.5" style={{ color: "#aaa" }}>
              <ShieldIcon />
              <span className="text-xs">Secure Login — Your data is encrypted</span>
            </div>
          </form>
          ...
          <Link
            ...
            style={{ border: "1.5px solid #E799AA", color: "#8B1A4A", background: "transparent" }}
          >
